...
def graph_fitnessVSgenerations(fitness_values, generations, n_experiments):
    for n in n_experiments:
        ...
        plt.ylabel('Fitness')
        # plt.show()
        plt.savefig('fitnessVSgenerations%03d.png' % n)


def graph_distanceVSgenerations(distance_values, generations, n_experiments):
    for n in n_experiments:
        # Compute the x and y coordinates
        ...
        plt.ylabel('Distance')
        # plt.show()
        plt.savefig('distanceVSgenerations%03d.png' % n)


def graph_numGensVSgenerations(gen_size, generations, n_experiments):
    for n in n_experiments:
        # Compute the x and y coordinates
        ...
        plt.ylabel('Gen Size')
        # plt.show()
        plt.savefig('genSizeVSgenerations%03d.png' % n)
...
def print_graphs(generations, fitness_values, distance_values, gen_size, n_experiments):  # , number_mutations):
    graph_fitnessVSgenerations(fitness_values, generations, n_experiments)
    graph_distanceVSgenerations(distance_values, generations, n_experiments)
    graph_numGensVSgenerations(gen_size, generations, n_experiments)

    # graph_numMutVSgenerations(number_mutations, generations)


def print_FGMgraphs(generations, fitness_values, distance_values, n_experiments):  # , number_mutations):
    graph_fitnessVSgenerations(fitness_values, generations, n_experiments)
    graph_distanceVSgenerations(distance_values, generations, n_experiments)
    # graph_numMutVSgenerations(number_mutations, generations)
...
class Organism:
    ...
    def run(self):
        ...
        return fgm_mode, generations, fitness_values, distance_values, gen_size, selected_genotype, selected_phenotype, \
               distance_selected
...
def main():
    model = Organism(
        ...
        initial_point=[10.0, 10.0, 10.0, 10.0, 10.0],  # Initial point
        n_dim=5,
    ...
    n_experiments = 30
    for n in n_experiments:
        fgm_mode, generations, fitness_values, distance_values, gen_size, selected_genotype, selected_phenotype, \
        distance_selected = model.run()
        if fgm_mode:
            print_FGMgraphs(generations, fitness_values, distance_values, n_experiments)
        else:
            print_graphs(generations, fitness_values, distance_values, gen_size, n_experiments)
        n += 1
